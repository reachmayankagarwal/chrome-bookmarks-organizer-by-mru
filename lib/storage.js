 ...
 *   getMigrations(area)   → [{ fromVersion, toVersion, migrate(data) }]
 */
...
function defaultLocalState() {
  return {
    ...
    snapshots:         [],      // [{ takenAt, summary, tree: [{id,parentId,index,title,url}] }] — FIFO cap 5
 ...
 * @property {function} getMigrations - Returns migration list for an area
 */
const storage = {
...
export { storage as default, getMigrations };
